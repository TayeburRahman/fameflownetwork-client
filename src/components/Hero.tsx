...
const Hero = () => {
  ...
  return (
    ...
    >
      {/* title description */}
      <div className="heading-text space-y-7 max-md:space-y-3 col-span-3 pe-14 max-md:pe-2" data-aos="fade-right">
        ...
        <p className="text-[17px] max-md:text-[13px]">
          ...
          Step into the spotlight with your story featured across our network of 200 influential news sites, reaching an impressive audience of 100 million visitors each month. Elevate your visibility and search rankings with a powerful exposure boost by showcasing your content.
        </p>
